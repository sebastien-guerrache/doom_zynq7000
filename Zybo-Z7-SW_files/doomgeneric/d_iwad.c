...
static boolean_doom iwad_dirs_built = doom_false;
...
// Returns doom_true if the specified path is a path to a file
// of the specified name.

static boolean_doom DirIsFile(char *path, char *filename)
{
    size_t path_len;
    size_t filename_len;

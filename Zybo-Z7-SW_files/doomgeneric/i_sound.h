...
struct sfxinfo_struct
{
    ...
    // lump name.  If we are running with use_sfx_prefix=doom_true, a
...
typedef struct
{
    ...
    // Returns doom_true if successfully initialised

    boolean_doom (*Init)(boolean_doom use_sfx_prefix);
    ...
    boolean_doom (*SoundIsPlaying)(int channel);
...
void I_InitSound(boolean_doom use_sfx_prefix);
...
boolean_doom I_SoundIsPlaying(int channel);
...
typedef struct
{
    ...
    void (*PlaySong)(void *handle, boolean_doom looping);
    ...
    boolean_doom (*MusicIsPlaying)(void);
...
void I_PlaySong(void *handle, boolean_doom looping);
void I_StopSong(void);
boolean_doom I_MusicIsPlaying(void);

...
static void saveg_read_player_t(player_t *str)
{
    ...
    // boolean_doom cards[NUMCARDS];
    for (i=0; i<NUMCARDS; ++i)
    {
        str->cards[i] = saveg_read32();
    }

    // boolean_doom backpack;
    ...
    // boolean_doom weaponowned[NUMWEAPONS];
...
boolean_doom P_ReadSaveGameHeader(void)
{
    int	 i; 
    byte a, b, c; 
...
//
// Read the end of file marker.  Returns doom_true if read successfully.
// 

boolean_doom P_ReadSaveGameEOF(void)
{
    int value;

...
// PIT_StompThing
//
boolean_doom PIT_StompThing (mobj_t* thing)
{
    fixed_t	blockdist;
...
//
boolean_doom PIT_CheckLine (line_t* ld)
{
...
// PIT_CheckThing
//
boolean_doom PIT_CheckThing (mobj_t* thing)
{
    fixed_t		blockdist;
    boolean_doom		solid;
    int			damage;
...
//
boolean_doom P_ThingHeightClip (mobj_t* thing)
{
    boolean_doom		onfloor;
...
// PTR_SlideTraverse
//
boolean_doom PTR_SlideTraverse (intercept_t* in)
{
    line_t*	li;
...
// PTR_ShootTraverse
//
boolean_doom PTR_ShootTraverse (intercept_t* in)
{
    fixed_t		x;
    fixed_t		y;
    fixed_t		z;
...
boolean_doom	PTR_UseTraverse (intercept_t* in)
{
    int		side;
    ...
    //	return doom_false;		// don't use back side
...
//
boolean_doom PIT_RadiusAttack (mobj_t* thing)
{
    fixed_t	dx;
    fixed_t	dy;
    fixed_t	dist;
...
// PIT_ChangeSector
//
boolean_doom PIT_ChangeSector (mobj_t*	thing)
{
    mobj_t*	mo;

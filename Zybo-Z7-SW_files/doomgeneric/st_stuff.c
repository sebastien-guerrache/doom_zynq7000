...
static boolean_doom		st_firsttime;
...
static boolean_doom		st_statusbaron;

// whether status bar chat is active
static boolean_doom		st_chat;

// value of st_chat before message popped up
static boolean_doom		st_oldchat;

// whether chat window has the cursor on
static boolean_doom		st_cursoron;

// !deathmatch
static boolean_doom		st_notdeathmatch; 

// !deathmatch && st_statusbaron
static boolean_doom		st_armson;

// !deathmatch
static boolean_doom		st_fragson; 
...
// used for evil grin
static boolean_doom	oldweaponsowned[NUMWEAPONS]; 
...
void ST_updateWidgets(void)
{
    ...
    // if (*w_ready.on)
    //  STlib_updateNum(&w_ready, doom_true);
...
void ST_drawWidgets(boolean_doom refresh)
{
    int		i;
...
void ST_Drawer (boolean_doom fullscreen, boolean_doom refresh)
{
...
static boolean_doom	st_stopped = doom_true;

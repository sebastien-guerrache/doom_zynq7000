...
boolean_doom F_CastResponder (event_t *ev);
...
boolean_doom F_Responder (event_t *event)
{
...
int		casttics;
state_t*	caststate;
boolean_doom		castdeath;
int		castframes;
int		castonmelee;
boolean_doom		castattacking;
...
void F_CastDrawer (void)
{
    ...
    flip = (boolean_doom)sprframe->flip[0];

...
boolean_doom NET_ReadInt8(net_packet_t *packet, unsigned int *data);
boolean_doom NET_ReadInt16(net_packet_t *packet, unsigned int *data);
boolean_doom NET_ReadInt32(net_packet_t *packet, unsigned int *data);

boolean_doom NET_ReadSInt8(net_packet_t *packet, signed int *data);
boolean_doom NET_ReadSInt16(net_packet_t *packet, signed int *data);
boolean_doom NET_ReadSInt32(net_packet_t *packet, signed int *data);

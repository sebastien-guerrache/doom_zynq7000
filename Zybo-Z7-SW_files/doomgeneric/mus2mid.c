...
static boolean_doom WriteTime(unsigned int time, MEMFILE *midioutput)
{
...
static boolean_doom WriteEndTrack(MEMFILE *midioutput)
{
...
static boolean_doom WritePressKey(byte channel, byte key,
...
static boolean_doom WriteReleaseKey(byte channel, byte key,
                               MEMFILE *midioutput)
{
...
static boolean_doom WritePitchWheel(byte channel, short wheel,
                               MEMFILE *midioutput)
{
...
static boolean_doom WriteChangePatch(byte channel, byte patch,
                                MEMFILE *midioutput)
{
...
static boolean_doom WriteChangeController_Valued(byte channel,
                                            byte control,
                                            byte value,
                                            MEMFILE *midioutput)
{
...
static boolean_doom WriteChangeController_Valueless(byte channel,
                                               byte control,
                                               MEMFILE *midioutput)
{
...
static boolean_doom ReadMusHeader(MEMFILE *file, musheader *header)
{
    boolean_doom result;
...
boolean_doom mus2mid(MEMFILE *musinput, MEMFILE *midioutput)
{

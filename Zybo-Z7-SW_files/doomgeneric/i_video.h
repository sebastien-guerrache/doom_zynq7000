...
typedef struct
{
    ...
    // Return doom_true if draw was successful.

    boolean_doom (*DrawScreen)(int x1, int y1, int x2, int y2);

    // If doom_true, this is a "poor quality" mode.  The autoadjust
    ...
    boolean_doom poor_quality;
} screen_mode_t;

typedef boolean_doom (*grabmouse_callback_t)(void);
...
extern boolean_doom screenvisible;

extern float mouse_acceleration;
extern int mouse_threshold;
extern int vanilla_keyboard_mapping;
extern boolean_doom screensaver_mode;
extern int usegamma;
...
extern boolean_doom palette_changed;

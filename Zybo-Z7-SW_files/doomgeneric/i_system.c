...
{
    atexit_func_t func;
    boolean_doom run_on_error;
    atexit_listentry_t *next;
};

static atexit_listentry_t *exit_funcs = NULL;

void I_AtExit(atexit_func_t func, boolean_doom run_on_error)
{
...
// I_ConsoleStdout
//
// Returns doom_true if stdout is a real console, doom_false if it is a file
//

boolean_doom I_ConsoleStdout(void)
{
#ifdef _WIN32
...
static boolean_doom already_quitting = doom_false;
...
boolean_doom I_GetMemoryValue(unsigned int offset, void *value, int size)
{
    static boolean_doom firsttime = doom_true;

    if (firsttime)
    {
        int p, i, val;

        firsttime = doom_false;
        i = 0;

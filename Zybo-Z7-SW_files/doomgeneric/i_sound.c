...
static boolean_doom SndDeviceInList(snddevice_t device, snddevice_t *list,
                               int len)
{
    int i;
...
static void InitSfxModule(boolean_doom use_sfx_prefix)
{
    int i;
...
{  
    boolean_doom nosound, nosfx, nomusic;

...
boolean_doom			chat_on;
static hu_itext_t	w_chat;
static boolean_doom		always_off = doom_false;
static char		chat_dest[MAXPLAYERS];
static hu_itext_t w_inputbuffer[MAXPLAYERS];

static boolean_doom		message_on;
boolean_doom			message_dontfuckwithme;
static boolean_doom		message_nottobefuckedwith;
...
static boolean_doom		headsupactive = doom_false;
...
boolean_doom HU_Responder(event_t *ev)
{

    static char		lastmessage[HU_MAXLINELENGTH+1];
    char*		macromessage;
    boolean_doom		eatkey = doom_false;
    static boolean_doom	altdown = doom_false;
    unsigned char 	c;
    int			i;
    int			numplayers;

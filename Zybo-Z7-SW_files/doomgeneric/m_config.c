...
typedef struct
{
    ...
    // If doom_true, this config variable has been bound to a variable
    // and is being used.
    boolean_doom bound;
} default_t;

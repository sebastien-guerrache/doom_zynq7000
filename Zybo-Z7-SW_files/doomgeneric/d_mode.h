...
boolean_doom D_ValidGameMode(GameMission_t mission, GameMode_t mode);
boolean_doom D_ValidGameVersion(GameMission_t mission, GameVersion_t version);
boolean_doom D_ValidEpisodeMap(GameMission_t mission, GameMode_t mode,
                          int episode, int map);
int D_GetNumEpisodes(GameMission_t mission, GameMode_t mode);
boolean_doom D_IsEpisodeMap(GameMission_t mission);

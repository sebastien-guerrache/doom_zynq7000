...
static boolean_doom I_Scale1x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
    int w = x2 - x1;
...
static boolean_doom I_Scale2x(int x1, int y1, int x2, int y2)
{
...
static boolean_doom I_Scale3x(int x1, int y1, int x2, int y2)
{
...
static boolean_doom I_Scale4x(int x1, int y1, int x2, int y2)
{
...
static boolean_doom I_Scale5x(int x1, int y1, int x2, int y2)
{
...
static boolean_doom I_Stretch1x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Stretch2x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Stretch3x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Stretch4x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Stretch5x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Squash1x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Squash2x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Squash3x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Squash4x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;
...
static boolean_doom I_Squash5x(int x1, int y1, int x2, int y2)
{
    byte *bufp, *screenp;
    int y;

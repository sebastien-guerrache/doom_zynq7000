...
//
boolean_doom PIT_AddThingIntercepts (mobj_t* thing)
{
    fixed_t		x1;
    fixed_t		y1;
    fixed_t		x2;
...
{
    {4,   NULL,                          doom_false},
    {4,   NULL, /* &earlyout, */         doom_false},
    {4,   NULL, /* &intercept_p, */      doom_false},
    {4,   &lowfloor,                     doom_false},
    {4,   &openbottom,                   doom_false},
    {4,   &opentop,                      doom_false},
    {4,   &openrange,                    doom_false},
    {4,   NULL,                          doom_false},
    {120, NULL, /* &activeplats, */      doom_false},
    {8,   NULL,                          doom_false},
    {4,   &bulletslope,                  doom_false},
    {4,   NULL, /* &swingx, */           doom_false},
    {4,   NULL, /* &swingy, */           doom_false},
    {4,   NULL,                          doom_false},
    {40,  &playerstarts,                 doom_true},
    {4,   NULL, /* &blocklinks, */       doom_false},
    {4,   &bmapwidth,                    doom_false},
    {4,   NULL, /* &blockmap, */         doom_false},
    {4,   &bmaporgx,                     doom_false},
    {4,   &bmaporgy,                     doom_false},
    {4,   NULL, /* &blockmaplump, */     doom_false},
    {4,   &bmapheight,                   doom_false},
    {0,   NULL,                          doom_false},
};
